...
async function analyzeWebPage(url, options) {
    ...
    console.log(chalk`Analyze of {yellow.bold external resources} finished.`);
    //=============
    console.log(chalk`Analyze of {red.bold alexa data} started.`);
    result.alexaInfo = await alexaAnalyze.getAlexaInfo(url);
    console.log(chalk`Analyze of {red.bold alexa data} finished.`);
    //=============
    ...
    console.log(chalk`Analyze of {blue.bold technologies} finished.`);    
    //=============
